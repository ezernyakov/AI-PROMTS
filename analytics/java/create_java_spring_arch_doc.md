...
1. Технологический стек
     ...
     <Список технологии, бибилиотек с кратким описанием почему используем. В порядке приоритетности для сервиса. В виде таблицы.>
      ...
      Пример:
       ...
       | Технолонгия | Версия | Описание                                              | 
       | ----------- | ----- | -----------------------------------                    | 
       | Java        |  XX   | последняя стабильная версия java                       |
       | Java Spring | X.X.X | Бизнес-логика обработки данных                         |
       | ...         | ...   | ...                                                    |
...
## Требования к технической документации по архитектуре
  ...
  3. Примеры кода в документе должны быть обезличенными в виде абстрактного шаблона, показывающего суть, а не полноценную реализацию. Использовать такие общие названия, как MyService1, MyService2, ExternalAdapter, MyRepository, myMethod и подобные.
